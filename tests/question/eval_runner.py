...
SEED_URLS: dict[str, tuple[list[str], str]] = {
    ...
    "C006-L1": ([LIEPIN_ROLE_URLS["java"], IGUOPIN_SEARCH["java"]], "liepin 后端 role landing + iguopin Java 搜索 fallback"),
    "C007-L1": ([LIEPIN_ROLE_URLS["java"], IGUOPIN_SEARCH["java"]], "liepin 后端 role landing + iguopin Java 搜索 fallback"),
    "C008-L1": ([LIEPIN_ROLE_URLS["java"], IGUOPIN_SEARCH["java"]], "liepin 后端 role landing + iguopin Java 搜索 fallback"),
    "C009-L1": ([LIEPIN_ROLE_URLS["frontend"], IGUOPIN_SEARCH["frontend"]], "liepin 前端 role landing + iguopin 前端搜索 fallback"),
