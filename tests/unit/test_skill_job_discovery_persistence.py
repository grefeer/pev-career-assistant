...
from skill.job_discovery.runtime import persistence
from skill.job_discovery.runtime.persistence import (
    state_check,
    state_mark,
...
# ---------------------------------------------------------------------------
# append_errors_jsonl (moved from test_skill_wechat_slice.py, Task 10)
# ---------------------------------------------------------------------------
