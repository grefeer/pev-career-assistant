...
_EXECUTOR_OPERATING_PROCEDURE = (
    ...
    "captured evidence; after two consecutive same-class failures stop "
    "and emit needs_user instead of burning the tool budget.\n"
    "8. Tools whose input ports declare confirmed facts must receive "
    "them verbatim from private_context; never omit or empty them.\n"
