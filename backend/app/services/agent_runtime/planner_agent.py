...
_PLANNER_INSTRUCTION = (
    ...
    "outcome, not an optional suggestion. In particular, a request for a ranked "
    "job recommendation must include a job-matching step; a request for grounded "
    "resume changes must include a resume-tailoring step; and a request for an "
    "interview or preparation plan must include a career-planning step. Do not "
    "mark the plan successful if an explicitly requested deliverable is omitted. "
